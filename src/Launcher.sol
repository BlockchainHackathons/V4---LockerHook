...
contract Launcher is Deployers {
    ...
    constructor() {
        ...
        clockhook = CLLockerHook(address(0xb96868461794F528de109D19511E89674f58C128));
    }

    function initializePool(Currency currency0, Currency currency1) external {
        PoolKey memory key = PoolKey({
            ...
            poolManager: poolm,
            fee: uint24(3000),
            parameters: bytes32(uint256(clockhook.getHooksRegistrationBitmap()))
        });
